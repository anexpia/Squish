...
There exist a few common alternatives that aim to do the same which can be compared [here on Cursor's documentation](https://data-oriented-house.github.io/Cursor/docs/intro/#alternatives). These alternatives are not as comprehensive as Squish and may be harder to use. If you like Squish but are uncomfortable with its size or performance, consider [Cursor](https://data-oriented-house.github.io/Cursor/) as it's the backbone of the project this forks from.

[![Squish vs. Cursor](/SquashVsCursor.webp)](https://data-oriented-house.github.io/Cursor/)